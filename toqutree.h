...
private:
   ...
   */
   ...
   double getEntropyTopLeftQ(pair<int, int> curSplitPos, long rectArea, int width, int height, stats s);

   double getEntropyTopRightQNoSplit(pair<int, int> curSplitPos, long rectArea, int width, int height, stats s);
   ...
   double getEntropyFromFour(pair<int,int> ulTopRight, pair<int,int> lrTopRight, 
      ...
      pair<int,int> ulBottomLeft,pair<int,int> lrBottomLeft, 
      stats s, long rectArea);

   double getEntropyFromTwo(pair<int,int> ulTop, pair<int,int> lrTop, 
      pair<int,int> ulBottom, pair<int,int> lrBottom, stats s, long rectArea);

   double getEntropyBottomRightQfourPerfectSquares(pair<int, int> curSplitPos, long rectArea, 
